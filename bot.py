...
COATINGS = [
    ...
    {
        "id": 3,
        "name": "Антискользящее эпоксидное покрытие для паркинга, ~3,5-4мм",
        "layers": [
    ...
    {
        "id": 4,
        "name": "Декоративное износостойкое покрытие 'чипсовый ковёр', ~3,5-4мм",
        "layers": [
    ...
    {
        "id": 5,
        "name": "Полиуретанцементное гладкое покрытие для пищевых производств, ~4мм",
        "layers": [
    ...
    {
        "id": 6,
        "name": "Полиуретанцементное антискользящее покрытие для пищевых производств, ~6мм",
        "layers": [
            {"name": "Грунт", "material": "Специальный трёхкомпонентный полиуретанцементный грунт", "consumption": 0.6, "package": 12.0},
            {"name": "Основной слой", "material": "Термохимстойкий трёхкомпонентный полиуретанцементный состав", "consumption": 8.5, "package": 40},
            {"name": "Засыпка 'под шубу'", "material": "Прокаленный минеральный заполнитель фр. 0,4-0,8", "consumption": 6, "package": 25},
            {"name": "Запечатывающий слой", "material": "Специальный окрасочный трёхкомпонентный состав", "consumption": 0.8, "package": 10.8}
        ]
    }
]
...
4\. Декоративное износостойкое покрытие \'чипсовый ковёр\' толщиной \~3,5\-4мм
